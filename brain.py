...
NOVEL_UNIVERSE = {
    ...
    "writing_principles": [
        ...
        "Subconscious branding: nama 'Clevia' dan nama produk boleh disebut natural sebagai bagian dari cerita — bukan dilarang, hanya jangan jadi kalimat pembuka yang terasa seperti iklan.",
    ],
    "chapters": [
        {
...
- DILARANG: botol produk, kemasan, foto produk close-up
- DIPERBOLEHKAN: logo Clevia muncul subtle di salah satu sudut gambar (kecil, elegan, seperti watermark premium) — bukan di tengah, bukan mendominasi komposisi
...
{{
  ...
  "hero_image_prompt": "Bahasa Inggris. Photorealistic lifestyle photo. NO PEOPLE — purely environmental shot, zero humans. Choose ONE scene: (a) INTERIOR — sunlit empty living room, kitchen, or bedroom, fresh tropical flowers in vase, morning light through sheer curtains, clean gleaming surfaces, linen textures, tropical plants, herbal freshness in the air; (b) NATURE OUTDOOR — lush tropical Indonesian garden, rice terraces at golden hour, coastal morning mist, tropical forest path with dappled light, fresh botanicals close-up. Mood must match caption: peaceful = soft warm light, refreshing = bright morning, nostalgic = golden hour. Bali resort or Indonesian nature aesthetic. NO people, NO humans, NO hands, NO faces, NO product bottles, NO packaging. Small elegant Clevia logo subtly in one corner.",
  "tiktok_image_prompts": [
    ...
    "Slide 3 (Bahasa Inggris): After / result. Pristine clean Indonesian home, sparkling surfaces, warm golden light, fresh flowers, family warmth, small Clevia logo subtle in corner, no product packaging visible."
  ]
}}
"""
